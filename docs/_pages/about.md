...
- **Jane Condon** — data collection, geographic accessibility analysis, index analysis
- **Ngan (Jane) Vu** — data collection, stroke risk analysis, index methodology
- **Cathleen Xi** — data collection, healthcare access analysis
- **Mikko Palis** — engineering, pipeline & site
- **Nitya Nemani** — UI/UX design 

## Bios:

**Jane Condon**: 

[Github](https://github.com/janecondon) [Linkedin](https://www.linkedin.com/in/jane-condon-/) 
...
*Draft skeleton — add bios, photos (docs/images/), and links as the team
prefers.*
